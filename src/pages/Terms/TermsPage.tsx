    ...
    <>
      ...
      >
        ...
        >
          ...
          <Typography
            variant="body2"
            sx={{ mb: 4, textAlign: "justify", lineHeight: "28px",letterSpacing:"0.25px" }}
          >
          ...
          <Typography sx={{ mb: 4, textAlign: "justify", lineHeight: "28px",letterSpacing:"0.25px" }}>
            ...
            <br />
            <ul style={{listStyleType: "disc", paddingLeft: "14px", lineHeight: "48px", fontSize: "16px"}}>
              <li>The Client has made efforts to make themselves aware of the various risks associated with executing transactions on the various Exchanges, and in particular, the risks involved in online...</li>
              <li>The Client has made efforts to make themselves aware of the various risks associated...</li>
              <li>The Client has made efforts to make themselves aware of the various risks associated </li>
              <li>The Client has made efforts to make themselves aware of the various risks associated </li>
              <li>The Client has made efforts to make themselves aware of the various risks associated with executing transactions on the various Exchanges, and in particular, the risks involved in online...</li>
              <li>The Client has made efforts to make themselves aware of the various risks associated </li>
